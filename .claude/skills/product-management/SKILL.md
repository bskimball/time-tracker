...
- **database-engineer**: To query databases for product metrics and user behavior data.
- **data-analyst**: To perform deeper quantitative analysis for feature decisions.
- **frontend-developer**: To implement features designed in PRDs.
- **frontend-design**: To create visual designs and prototypes for features.
- **api-developer**: To build internal tools and APIs for product operations.
