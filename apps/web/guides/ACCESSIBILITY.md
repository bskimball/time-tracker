...
```tsx
<div>
	<Input label="Password" type="password" aria-describedby="password-help" />
...
<Tabs>
	<TabList role="tablist">
		<Tab id="tab-1" role="tab" aria-selected={activeTab === "tab-1"} aria-controls="panel-1">
			Overview
		</Tab>
	</TabList>

	<TabPanel id="panel-1" role="tabpanel" aria-labelledby="tab-1" hidden={activeTab !== "tab-1"}>
		Content...
	</TabPanel>
</Tabs>
```
