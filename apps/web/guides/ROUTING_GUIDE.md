...
- Uses specialized `KioskTimeClock` component from `apps/web/src/routes/time-clock/kiosk/client.tsx`
...
**Location:** `apps/web/src/routes/time-clock/route.tsx`
...
```typescript
// apps/web/src/routes/time-clock/actions.ts
"use server";
...
```typescript
// apps/web/src/routes/time-clock/client.tsx
"use client";
...
- `AUTHENTICATION_GUIDE.md` - Authentication patterns in RSC
