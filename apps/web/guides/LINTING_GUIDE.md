...
- **Design System Exceptions**: Special rules for `packages/design-system/apps/web/src/components/` components
...
### Design System Components (`packages/design-system/apps/web/src/components/`)
...
```json
{
	"overrides": [
		{
			"files": "packages/design-system/apps/web/src/components/**/*",
			"options": {
				"printWidth": 120
			}
		}
