...
```tsx
<div className="bg-warehouse-floor">
  {/* Grid pattern with diagonal safety stripes */}
</div>
```
...
<div className="bg-metal">
  {/* Brushed metal gradient with subtle lines */}
</div>
```
...
<div className="panel-shadow">
  {/* Industrial panel with inset lighting and depth */}
</div>
```
...
<Card className="panel-shadow border-sidebar-border">
  <CardHeader className="border-b-2 border-sidebar-border bg-muted">
    <CardTitle className="font-industrial uppercase">
      Shift Status
    </CardTitle>
  </CardHeader>
  <CardBody className="font-mono-industrial">
    12:34:56 | 8.5 HRS
  </CardBody>
</Card>
```
...
```tsx
<div className="font-mono-industrial text-lg">
  STATION-042 | ACTIVE
</div>
```
