...
import { KioskContext, useKioskContext, type KioskContextValue } from "~/routes/time-clock/context";
import { useAutoRefresh, useKioskMode } from "~/routes/time-clock/hooks";
import { notify, subscribe } from "~/routes/time-clock/notifications";
import { useOfflineActionQueue } from "~/routes/time-clock/offline-queue";
import {
	calculateNetHours,
	isOvertime,
	getWeekBounds,
	DEFAULT_DAILY_LIMIT,
} from "~/routes/time-clock/utils";
import type { OfflineEndpoint } from "~/routes/time-clock/offline-queue";
...
function ClockInForm({
	...
	return (
		<Card>
			<CardHeader>
				<CardTitle>Floor Clock In/Out</CardTitle>
			</CardHeader>
			<CardBody>
...
function ActiveSessions({
	...
	return (
		<Card>
			<CardHeader>
				<CardTitle>Active Floor Sessions</CardTitle>
			</CardHeader>
			<CardBody>
				{activeLogs.length === 0 ? (
...
function TimeHistory({
	...
	return (
		<Card>
			<CardHeader>
				<CardTitle>Floor Time History</CardTitle>
			</CardHeader>
			<CardBody>
